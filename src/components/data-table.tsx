  ...
  return (
    <div className="w-full flex-col justify-start gap-6">
              ...
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  <TableCell
                    ...
                    className="h-24 text-center px-6 py-2"
                  >
                    No results.
                  </TableCell>
                </TableRow>
      ...
      {selectedItem && (
        <>
          {isMobile ? (
            <Drawer open={isSheetOpen} onOpenChange={setIsSheetOpen} direction="bottom">
              <DrawerContent>
                ...
                <DrawerFooter>
                  ...
                  <DrawerClose asChild>
                    <Button variant="outline">Done</Button>
                         ...
                         <Drawer open={isSheetOpen} onOpenChange={setIsSheetOpen} direction="right">
               <DrawerContent>
                 <DrawerHeader className="gap-1">
                   <DrawerTitle>{selectedItem.header}</DrawerTitle>
                   <DrawerDescription>
